...
const UserDetails = ({ userEmail, promoCode }) => {
  return (
    <div>
      <div className="container mt-5">
        ...
        >
          ...
          <p className='mt-3'><strong style={{color: "goldenrod"}}>Email : </strong> Demo@gmail.com</p>
          <p className='mt-3'><strong style={{color: "goldenrod"}}>Promo Code : </strong> HUI76H</p>
